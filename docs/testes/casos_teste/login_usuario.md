...
| **CT-L003** | Login inválido | Nenhuma | Cliente informar um e-mail não cadastrado ou uma senha incorreta | Resposta status **401** com mensagem *"Credenciais invalidas."* |
